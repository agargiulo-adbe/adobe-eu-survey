...
(() => {
  ...
  class DeckStage extends HTMLElement {
    ...
    _makeThumb(slide) {
      ...
      // Eager materialization: the lazy IntersectionObserver can fail to
      // fire in throttled/just-revealed states, leaving blank thumbnails.
      // Building the clone now guarantees the slide miniature is visible.
